...
EMAIL_TEMPLATE_DIR = settings.BASE_DIR - 2 + 'emails'
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if 'MJMLError' in message:
            ...
            return
        self.stdout.write(f'cd {EMAIL_TEMPLATE_DIR} && bash -c ./mjml-transpile.sh')
        ...
        with open(settings.BASE_DIR - 1 + 'fixtures' + 'email-templates.json', "w") as f:
            f.write(data)
